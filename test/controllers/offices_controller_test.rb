...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { city: @office.city, country: @office.country, mail_code: @office.mail_code, state: @office.state, street: @office.street } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { city: @office.city, country: @office.country, mail_code: @office.mail_code, state: @office.state, street: @office.street } }
